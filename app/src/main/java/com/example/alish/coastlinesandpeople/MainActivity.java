...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton emergencyCall = (FloatingActionButton) findViewById( R.id.call );
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_first_layout) {
            ...
            fragmentManager.beginTransaction().replace(R.id.content_frame,new secondmenuFragment()).commit();

        } else if (id == R.id.nav_third_layout) {
            fragmentManager.beginTransaction().replace(R.id.content_frame,new ThirdStandard()).commit();
